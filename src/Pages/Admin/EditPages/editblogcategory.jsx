...
const EditBlogCategory = () => {
  ...
  const getData = async () => {
    ...
    const apiUrl = `${BaseUrl}clinic/manageblogcategories/${id}`;
    ...
    if (isValid) {
      ...
      if (result?.isConfirmed) {
        try {
          ...
          Swal.fire({
            title: "Success!",
            text: "Blog Category has been updated successfully.",
            icon: "success",
          ...
          Swal.fire({
            title: "Error!",
            text: `There was an issue updating the Blog Category: ${error.message}`,
            icon: "error",
            confirmButtonText: "OK",
          });
        }
